...
main = tkinter.Tk()
main.title("Driver Sleepness Alert Monitoring")
        ...
        for rect in rects:
            ...
            if ear < EYE_AR_THRESH:
                ...
                if COUNTER >= EYE_AR_CONSEC_FRAMES:
                    cv2.putText(frame, "SLEEPINESS ALERT!", (10, 50),cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2)
            else:
                COUNTER = 0
                cv2.putText(frame, "Eyes Open ", (10, 30),cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 255, 0), 2)
            cv2.putText(frame, "EAR: {:.2f}".format(ear), (480, 30),cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2)
            if mouEAR > MOU_AR_THRESH:
                cv2.putText(frame, "Yawning, SLEEPINESS ALERT! ", (10, 70),cv2.FONT_HERSHEY_SIMPLEX, 0.7, (0, 0, 255), 2)
                yawnStatus = True
            ...
            cv2.putText(frame,"Visual Behaviour & Machine Learning Sleepiness Detection @ Sleepiness",(370,470),cv2.FONT_HERSHEY_COMPLEX,0.6,(153,51,102),1)
...
font = ('times', 16, 'bold')
title = Label(main, text='Driver Sleepiness Alert Monitoring System using Visual\nBehaviour and Machine Learning',anchor=W, justify=LEFT)
